...
import type { AfdianOrderInfo, AfdianOrderResponse } from 'afdian-api/dist/src/types/request';
...
export default class FetchOrders extends Subscription {
  ...
  public async updateOrders(orders: AfdianOrderInfo[]) {
    const { ctx } = this;
  ...
  public async fetchOrders(afdian: Afdian) {
